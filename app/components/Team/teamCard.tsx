...
const TeamCard: React.FC<TeamCardProps> = ({ team }) => {
  ...
  return (
    <Link href={`/teams/${team.id}`}>
      <div>
        <Card className="z-10 m-5 h-max rounded-md bg-gray-300 bg-opacity-20 bg-clip-padding shadow-[0_4px_12px_rgba(8,_112,_184,_0.7)] backdrop-blur-sm backdrop-filter transition-transform duration-300 ease-in-out hover:scale-105 hover:cursor-pointer">
