...
export const organizators = {
  Ментори: [
    {
      ...
      description: (
        <p>
          ...
          екип на ДЕСЕТОТО юбилейно издание на Hack&nbpsp;TUES&nbsp;X и
  ...
  "Екип Спонсори": [
    ...
    },
    {
      ...
      description: (
        <p>
          Обичам музика. И домати със сирене. Това е от мен.{" "}
  ...
  "Eкип Дизайн": [
    ...
    },
    {
      ...
      description: (
        <blockquote>
          <p>
            Уважаеми зрители, това беше всичко от нас за този вечер. Благодарим
