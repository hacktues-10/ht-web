        ...
        <div className="text-left">
          <Accordion type="single" collapsible>
            ...
            <AccordionItem value="2">
              <AccordionTrigger>
                Под каква форма ще участват завършилите?
              </AccordionTrigger>
              <AccordionContent>
                Завършилите ще се състезават помежду си в отбори с от 2-ма до
                3-ма участници и ще са в отделна категория. В техните отбори ще
                могат да участват само и единствено завършили. Те ще изготвят
                проекти на различна тема от тази на учениците и ще се изправят
                пред отделно жури.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="3">
              ...
              <AccordionContent>
                Крайният срок за регистрацията за завършилите е на{" "}
                <time dateTime="2024-01-12">12.01.2024 г.</time> включително или
                до изчерпване на местата, a регистрацията за настоящи ученици ще
                бъде отворена на 29.01 от 20:00 часа до 02.02 включително или до
