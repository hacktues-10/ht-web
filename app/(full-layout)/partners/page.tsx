...
export default function SponsorsAndPartners() {
  return (
    <section className="light relative flex flex-col gap-14 overflow-x-visible pb-14 pt-14 text-primary-foreground">
...
function PodkrepqTitle({ children }: PropsWithChildren<{}>) {
  return (
    <h2 className="scroll-m-20 pb-2 text-center text-4xl font-extrabold tracking-tight first:mt-0 md:text-5xl">
      {children}
    </h2>
  );
}
