...
export const HACKATHONS = [
  {
    ...
    name: "Hack TUES",
    logo: (
      <HTLogo className="text-white" key="hacktues">
  ...
  },
  {
    ...
    name: "Hack TUES 2",
    logo: (
      <HTLogo className="text-white" key="hacktues-2">
  ...
  },
  {
    ...
    name: "Hack TUES 3",
    logo: (
      <HTLogo className="text-white" key="hacktues-3">
  ...
  },
  {
    ...
    name: "Hack 30xTUES",
    logo: (
      <HTLogo className="text-[#00ffe4ff]" key="hacktues-30x">
  ...
  },
  {
    ...
    name: "Hack TUES 365",
    logo: (
      <HTLogo className="text-[#d6c6ad]" key="hacktues-365">
        Hack{" "}
  ...
  },
  {
    ...
    name: "Hack TUES 6",
    logo: (
      <HTLogo className="text-white" key="hacktues-6">
  ...
  },
  {
    ...
    logo: (
      <HTLogo key="hacktues-infinity" className="text-[#f7b7d3]">
        Hack TUES ∞
      </HTLogo>
    ),
  ...
  },
  {
    ...
    name: "Hack TUES S",
    logo: (
      <HTLogo key="hacktues-security" className="text-[#29838e]">
        <span className="text-[#a01824]">Hack</span> TUES{" "}
        <span className="text-[#a01824]">S</span>
      </HTLogo>
    ),
