export const HACKATHONS = [
  {
    ...
    winners: [
      ...
      },
      {
        place: "second",
        participants:
          "Антонио Миндов, Дария Никитова, Кристиана Иванова, Петър Петров, Ясен Алексиев",
        name: "R&T",
    ...
    description: (
      <>
        ...
        <p>
          ...
          възможност за това и съм убедена, че той ще се превърне в традиция за
          ТУЕС.“
        </p>
        <p>доц. д-р инж. Стела Стефанова, директор на ТУЕС</p>
      </>
    ),
  },
  {
    ...
    winners: [
      ...
      },
      {
        place: "second",
        participants:
          "Николета Далакчиева, Владимир Младенов, Марина Тихова, Лъчезар Младенов",
        name: "Walking Chaos",
        project:
    ...
    description: (
      <>
        ...
        <p>
          „Хакатонът е поредното доказателство, че учениците винаги има с какво
          да ни изненадат. Чудесните идеи, разработени от учениците, правят това
          състезание уникално и няма съмнение, че HackTUES вече се превръща в
          една от добрите традиции в ТУЕС.“
        </p>
        <p>доц. д-р инж. Стела Стефанова, директор на ТУЕС</p>
      </>
    ),
  },
  {
    ...
    winners: [
      ...
      },
      {
        place: "second",
        participants:
          "Телерик Арсов, Стефан Бабуков, Николай Милчев, Мартин Дацев",
        name: "To6o",
    ...
    winners: [
      {
        place: "first",
        participants:
          "Телерик Арсов, Ивона Мирчева, Владислав Георгиев, Мартин Дацев, Петър Милев",
        name: "COCOBE",
        project:
      ...
      },
      {
        place: "second",
        participants:
          "Георги Любенов, Виктор Велев, Антон Янчев, Самуил Георгиев",
        name: "Old and Bald",
        project:
      ...
      },
      {
        place: "third",
        participants:
          "Михаил Киров, Петър Николов, Денис Бързанов, Тони Пеловски, Стефан Стефанов",
        name: "IDK",
    ...
    specialPrizes: [
      {
        ...
        participants:
          "Георги Стефанов, Самуил Иванов, Владислав Миленков, Стефан Гълъбов",
      },
      {
        team: "Autardia",
        ...
        participants:
          "Кристиян Стоименов, Стела Касабова, Виолета Кабаджова, Стефани Стайкова, Стефан Босев",
      },
      {
        team: "Ime",
      ...
      },
      {
        ...
        participants:
          "Кристиян Стоименов, Калоян Ангелов, Виктория Радкова, Слав Кирилов, Християн Генчев",
      },
      {
        ...
        participants:
          "Александър Стоичков, Иван Димитров, Кристиян Йочев, Георги Корчаков, Виктор Петров",
      },
      {
        ...
        prize: "отличен от „Cloud Balkan“",
        participants:
          "Милен Илиев, Михаил Колев, Антонио Такев, Валери Добрев, Николай Йончев",
      },
      {
        team: "Thunder System",
        project: null,
        ...
        participants:
          "Мартин Вайер, Боян Иванов, Мартин Врачев, Мартин Дамянов, Петър Дамянов",
      },
    ],
    description: (
      <>
  ...
  },
  {
    ...
    winners: [
      ...
      },
      {
        place: "second",
        participants:
          "Владислав Георгиев, Мартин Дацев, Антонио Милев, Телерик Арсов",
        name: "Какводой",
        project:
      ...
      },
      {
        place: "third",
        participants:
          "Мартин Йорданов, Самуил Георгиев, Антон Янчев, Огнян Барух, Георги Любенов",
        name: "Babba4e",
        project:
    ...
    specialPrizes: [
      {
        ...
        participants:
          "Искрен Александров, Ангел Стоянов, Мартин Вайер, Мартин Георгиев, Денис Захариев",
      },
    ],
    description: (
      <>
    ...
    winners: [
      {
        place: "first",
        participants:
          "Ангел Пенчев, Симеон Георгиев, Боян Иванов, Богдан Миронов, Мирослав Мирчев",
        name: "Fanton",
        project:
    ...
    description: (
      <>
        ...
        <p>
          ...
          Медиен партньор на събитието беше DevStyleR. „Шестото издание на
          ученическия хакатон ни показа две много важни неща - учениците работят
          все по-ентусиазирано и това се вижда от все по-интересните проекти. И
          второ, приемствеността между поколенията става все по-голяма - виждаме
          как големите учат малките като ментори и като организатори. Надеждата
          е в младите хора - тези младежи, които са сред нас и които ще градят
          ИТ бъдещето на България. Аз ги поздравявам за техните успехи и се
          радвам, че нашата инвестиция в тяхното образование ще бъде оправдана
          многократно.“ - доц. д-р инж. Стела Стефанова, директор на ТУЕС
        </p>
      </>
    ),
  },
