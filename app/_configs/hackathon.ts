...
Идеална възможност за всеки, който иска да се потопи в света на вградените микрокомпютърни системи и да разшири своите знания и умения.`,
  ...
  },
  {
    ...
    description: `Последният ни Workshop ще ви отговори на всички въпроси по провеждането на емблематичния и обичания от всички туесари хакатон - Hack TUES. Какво е Hack TUES? Как протича той? В какво се забърках? Елате и разберете!`,
