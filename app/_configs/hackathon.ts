...
Идеална възможност за всеки, който иска да се потопи в света на вградените микрокомпютърни системи и да разшири своите знания и умения.`,
  ...
  },
  {
    ...
    description: `Започва откриващата церемония на живо от иновационен форум „Джон Атанасов“ на София Тех Парк, която ще бъде излъчвана в официалния канал на ТУЕС в YouTube.`,
  ...
  },
  {
    ...
    description: `
А каква е темата? В тематичната лекция ще разкрием постепенно главната тема и подтемите, по които ще работят учениците на десетото юбилейно издание на Hack TUES.`,
  ...
  },
  {
    ...
    description: `Завършилите участници ще работят по различна тема. Каква е тя? Ще научите на допълнителната тематична лекция преди началото на времето за работа.`,
  ...
  },
  {
    ...
    description: `Започва да тече времето на участниците за разработване на проектите по избраната от тях подтема. Работата ще кипи и кипи... Финалните версии трябва да бъдат предадени до 7:59 на 16 март.`,
  ...
  },
  {
    ...
    description: `Завършилите участници ще презентират своите проекти пред жури. Всеки отбор ще има по 7 минути за презентация и 8 минути за въпроси от журито. То ще оцени и класира най-добрите проекти измежду 14-те отбора от завършили ТУЕС-ари.
...
Кой ще спечели? Победителите ще бъдат обявени на закриващата церемония.`,
  ...
  },
  {
    ...
    description: `Започват седем паралелни полуфинала на учениците. По 10 отбора в полуфинал, те ще презентират своите проекти преди жури.
Всеки отбор ще има по 7 минути за презентация и 8 минути за въпроси от журито.
От всеки полуфинал журито ще излъчи по два отбора на финал. Финалистите ще бъдат обявени след края на полуфиналите.`,
    startDate: new Date("Mar 16 2024 08:00:00 GMT+0200"),
...
Ще бъдат връчени над 30 специални награди на отличилите-се отбори от нас и нашите спонсори, ИТ компании. След това ще обявим и победителите от десетото юбилейно издание на Hack TUES!`,
