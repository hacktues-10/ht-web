...
Идеална възможност за всеки, който иска да се потопи в света на вградените микрокомпютърни системи и да разшири своите знания и умения.`,
  ...
  },
  {
    ...
    description: `Започва откриващата церемония на живо от иновационен форум „Джон Атанасов“ на София Тех Парк, която ще бъде излъчвана на живо в официалния канал на ТУЕС в YouTube.`,
    startDate: new Date("Mar 13 2024 18:00:00 GMT+0200"),
    endDate: new Date("Mar 13 2024 19:00:00 GMT+0200"),
  },
  {
    type: "youtube",
    title: "Разкриване на темата за ученици",
    description: `
А каква е темата? Ще разкрием постепенно главната тема на учениците и подтемите на юбилейното издание на хакатона в тематична лекция.`,
    startDate: new Date("Mar 13 2024 19:30:00 GMT+0200"),
    endDate: new Date("Mar 13 2024 21:10:00 GMT+0200"),
  },
  {
    type: "youtube",
    title: "Разкриване на темата за завършили",
    description: `Завършилите участници ще работят по различна тема. Каква е тя? Ще научита на тематичната лекция преди началото на хакатона.`,
    startDate: new Date("Mar 13 2024 21:15:00 GMT+0200"),
    endDate: new Date("Mar 13 2024 21:45:00 GMT+0200"),
  },
  {
    type: "in-person",
    title: "Време за работа",
    description: `Започва да тече времето за разработване на проектите на участниците по темата. Работата ще кипи и кипи... Финалните версии трябва да бъдат предадени до 7:59 на 16 март.`,
  ...
  },
  {
    ...
    description: `Завършилите участници ще презентират своите проекти пред жури. Всеки отбор ше има по 7 минути за презентация и 8 минути за въпроси от журито. То ще оцени и класира най-добрите проекти измежду 14-те отбора от завършили ТУЕС-ари.
...
Кой ще спечели? Победителите ще бъдат обявени на закриващата церемония.`,
  ...
  },
  {
    ...
    description: `Започват седем паралелни полуфинала на учениците. По 10 отбора в полуфинал, отборите ще презентират своите проекти преди жури.
Всеки отбор ще има по 7 минути за презентация и 8 минути за въпроси от журито.
От всеки полуфинал журито ще излъчи два отбора на финал. Финалистите ще бъдат обявени след края на полуфиналите.`,
    startDate: new Date("Mar 16 2024 08:00:00 GMT+0200"),
...
Всеки финалист ще има по 7 минути за презентация и 8 минути за въпроси от журито. То ще оцени и класира най-добрите проекти измежду финалистите.`,
  ...
  },
  {
    ...
    description: `Предстои дългоочакваният момент – награждаването на най-добрите проекти!
    
Ще бъдат връчени и над 30 специални награди на отличилите-се отбори и участници от нашите спонсори, ИТ компании. След това ще обявим и победителите от десетото юбилейно издание на Hack TUES.`,
    startDate: new Date("Mar 16 2024 21:20:00 GMT+0200"),
