...
Идеална възможност за всеки, който иска да се потопи в света на вградените микрокомпютърни системи и да разшири своите знания и умения.`,
  ...
  },
  {
    ...
    description: `Започва откриващата церемония от иновационен форум „Джон Атанасов“ на София Тех Парк, която ще бъде излъчвана в официалния канал на ТУЕС в YouTube.`,
...
А каква е темата? В тематичната лекция ще разкрием постепенно главната тема и подтемите, по които ще работят учениците на десетото юбилейно издание на Hack TUES.`,
  ...
  },
  {
    ...
    description: `Започва да тече времето на участниците за разработване на проектите. Работата ще кипи и кипи... Финалните версии трябва да бъдат предадени до 7:59 на 16 март.`,
