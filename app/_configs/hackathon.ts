...
А каква е темата? В тематичната лекция ще разкрием постепенно главната тема и подтемите, по които ще работят учениците на десетото юбилейно издание на Hack TUES.`,
  ...
  },
  {
    ...
    description: `Завършилите участници ще работят по отделна тема. Каква е тя? Ще научите на допълнителната тематична лекция преди началото на времето за работа.`,
  ...
  Всеки отбор ще има по 7 минути за презентация и 8 минути за въпроси от журито. То ще оцени и класира най-добрите проекти измежду 14-те отбора от завършили ТУЕС-ари.
...
Накрая ще обявим и победителите от десетото юбилейно издание на Hack\u00a0TUES!`,
